...
function Chart(props) {
  ...
  useEffect(() => {
    ...
    gSunburst.append("circle").attr("r", radius).attr("opacity", 0);
    ...
    function updateBreadcrumbs(nodeArray, percentageString) {
      ...
      trailEnter
        ...
        .attr(
          ...
          (d, i) =>
            `translate(${
              i * (breadcrumbDimension.width + breadcrumbDimension.spacing)
            },0)`
        );
    ...
    const legendItem = legendContainer
      ...
      .attr(
        ...
        (d, i) =>
          `translate(0,${
            50 + i * (legendDimension.height + legendDimension.spacing)
          })`
      );
    legendItem
      .append("rect")
  ...
  }, [options]); // redraw chart if data changes
